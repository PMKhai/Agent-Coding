...
- **With target repo:** design artifacts in `[target-repo-path]/design/` (or the repo's existing design folder if one exists)
- **Without target:** `tasks/[project]/[task-id]/design/`
- `tasks/[project]/[task-id]/design/design-summary.md` — artifact list, design tokens used, decisions + rationale, anything left open for Coder Frontend
